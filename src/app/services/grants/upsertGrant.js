...
const action = async (req, res) => {
  ...
  try {
    logger.info(`Processing upsert grant. CorrelationId: ${req.correlationId}`);
    ...
    logger.error(`Error processing upsert for grant request - ${e.message}. CorrelationId: ${req.correlationId}`);
    throw e;
  }
};
