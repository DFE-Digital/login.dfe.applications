...
const list = async (req, res) => {
  ...
  try {
    logger.debug(
      `Processing list service grant tokens request. page: ${page}, pageSize: ${pageSize}`,
      { correlationId },
    );
    ...
    logger.error(
      `Error processing list service grant tokens request - page: ${page}, pageSize: ${pageSize}`,
